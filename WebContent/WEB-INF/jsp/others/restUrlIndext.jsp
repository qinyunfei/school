					...
					.confirm(
							...
							function(r) {
								if (r) {
									...
									$
											.post(
													'${pageContext.request.contextPath}/restful/dept',
													{
														deptno : row.deptno,
														_method : 'delete'
													},
...
<body>
	...
	<div id="toolbar">
		...
		<a class="easyui-linkbutton"
			data-options="iconCls:'icon-edit',plain:true" onclick="updateDept()">修改部门</a>
		<a class="easyui-linkbutton"
			data-options="iconCls:'icon-remove',plain:true"
			onclick="delectDept()">删除部门</a>
	...
	<div id="dlg" class="easyui-dialog"
		...
		<form id="fm" method="post"
			action="${pageContext.request.contextPath}/restful/dept">
